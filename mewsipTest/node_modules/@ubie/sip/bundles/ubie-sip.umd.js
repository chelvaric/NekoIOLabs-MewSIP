(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('sip.js/lib/UA')) :
    typeof define === 'function' && define.amd ? define('@ubie/sip', ['exports', '@angular/core', 'sip.js/lib/UA'], factory) :
    (global = global || self, factory((global.ubie = global.ubie || {}, global.ubie.sip = {}), global.ng.core, global.UA));
}(this, (function (exports, core, UA) { 'use strict';
    ...
    var SipService = /** @class */ (function () {
        ...
        function (config) {
            ...
            //create the client
            this.UserAgent = new UA.UA(options);
        };
        ...
        /** @nocollapse */ SipService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function SipService_Factory() { return new SipService(); }, token: SipService, providedIn: "root" });
        return SipService;
    }());
    if (false) {
        /** @type {?} */
...
//# sourceMappingURL=ubie-sip.umd.js.map
